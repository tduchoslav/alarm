...
class AlarmLastStatusTimestamp extends Component {    
    constructor(props) {
        super(props);
        this.state = {
                timestamp: null,
    ...
    render() {
        ...
        return (
                <AlarmLastTimestamp timestamp = {this.state.timestamp} ajaxCallResult = {this.state.ajaxCallResult} title='Status Timestamp' />
                );
    }
    
    componentDidMount() {
        console.debug('AlarmLastHeartBeatTimestamp mount.');
        let url = SERVER + SERVICE_BASE_URL + ALARM_LAST_STATUS_RELATIVE_URL;
...
export default AlarmLastStatusTimestamp;